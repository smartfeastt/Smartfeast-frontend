...
export default function Login() {
  return (
    <>
      {/* This page doesn't need the standard navbar banner; we keep it minimal */}
      <div className="min-h-screen flex">
            ...
            <div className="mt-8">
              <div className="mb-8">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Or <Link to="/signup" className="font-medium text-gray-800 hover:text-gray-900">create a new account</Link>
                </p>
              </div>
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center">
                    <input id="remember-me" type="checkbox" className="h-4 w-4 text-gray-600 focus:ring-gray-500 border-gray-300 rounded" />
                    <span className="ml-2 block text-sm text-gray-700">Remember me</span>
                  </label>

                  <div className="text-sm">
                    <a href="#" className="font-medium text-gray-800 hover:text-gray-900">Forgot your password?</a>
                  </div>
                </div>

                <div>
                  <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">Sign in</button>
                </div>
              </form>
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500">Or continue without login</span>
                  </div>
                </div>
        ...
        {/* Right - Image */}
        <div className="hidden lg:block relative w-0 flex-1 auth-container" style={{ backgroundImage: `url('http://static.photos/minimal/1200x630/1')` }}>
